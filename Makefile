...
#    Updated: 2024/04/19 13:57:00 by nvillalt         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
#···SRCS········#
SRC = main.c parse.c utils.c support_functions.c init.c validate_map.c graphs_init.c map_hooks.c movements.c error_free.c load_sprites.c
OBJ_NAME = $(SRC:%.c=%.o)
